...
const BirthdaysPage = () => {
  ...
  const handleSendBirthdayWish = async (client: ClientWithBirthday) => {
    // כאן תוכל להוסיף לוגיקה לשליחת ברכת יום הולדת
    // לדוגמה: שליחת SMS או אימייל
    toast.success(`נשלחה ברכת יום הולדת ל${client.first_name}`);
  };
