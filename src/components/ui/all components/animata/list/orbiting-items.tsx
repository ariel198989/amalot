import { Icons } from "@/components/ui/animata/list/icons";
import { cn } from "@/lib/utils";

export const testOrbitingItems = [
  <Icons.logo key="github" className="h-6 w-6" />,
  <Icons.logo key="twitter" className="h-6 w-6" />,
  <Icons.logo key="yarn" className="h-6 w-6" />,
  <Icons.logo key="tailwind" className="h-6 w-6" />,
  <Icons.logo key="framer" className="h-6 w-6" />,
  <Icons.logo key="apple" className="h-6 w-6" />,
];
